...
//// remove storage op select when option don't have
    ...
    // console.log(curPrice, comPrice, youSave)
      ...
      $(".set-op-value").on("click", function(){
        ...
        console.log($(this).closest(".common-accordian").find('.accordion'),`remove active`);

        console.log($(this).closest(".common-accordian").next('.common-accordian').find('.accordion '),'find next');
